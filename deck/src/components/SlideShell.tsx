  ...
  <div className="relative w-full h-full text-white overflow-hidden flex flex-col px-[5.2%] pt-[3.2%] pb-[clamp(66px,8vh,96px)]">
    {!bare && (
      <header className="relative z-10 w-full flex justify-between items-center">
        <Logo />
        <span className="text-white/55 font-medium tracking-wide" style={{ fontSize: "clamp(13.2px,1.3vw,18px)" }}>
          Red-Team Research
        </span>
        <span className="mono text-white/40" style={{ fontSize: "clamp(12px,1.2vw,15.6px)" }}>{page ?? ""}</span>
      </header>
    )}
